"""generate_lab_compute_tables.py — Frontier Lab Compute Table Generator
...
from frontier_lab_compute_model.py (whose priors live in lab_model_params.csv)
and shapes their sample arrays into the export table.

Usage
-----
    # Save CSVs to data/ and print row counts:
    python generate_lab_compute_tables.py
    ...
    # Individual getter:
    from generate_lab_compute_tables import get_year_end_by_lab
...
def build_year_end_table(samples):
    ...
    notes = f"Generated by generate_lab_compute_tables.py on {datetime.datetime.now():%Y-%m-%d %H:%M}"
    rows = []
